...
public class ApiController {
    ...
    @RequestMapping(value = "/aa01", method = RequestMethod.GET)
    public Page<Aa01> aa01List(@PageableDefault(size = 20) Pageable pageable)
    {
        return aa01Service.list(pageable);
    }
    @RequestMapping(value = "/aa01", method = RequestMethod.DELETE)
    ...
    @RequestMapping(value = "/aa01", method = RequestMethod.POST)
