...
public class WebContextConfiguration implements WebMvcConfigurer {
    ...
    private final ArrayList<String> convertList=new ArrayList<>();
    ...
    @Bean
    public ArrayList<String> getConvertList()
    {
        return convertList;
    }
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        registry.addResourceHandler("/fonts/**").addResourceLocations(CLASSPATH_RESOURCE_LOCATIONS + "static/fonts/")
                .setCachePeriod(20);
        registry.addResourceHandler("/actor/**").addResourceLocations(CLASSPATH_RESOURCE_LOCATIONS + "static/actor/")
                .setCachePeriod(20);
        registry.addResourceHandler("/works/**").addResourceLocations(CLASSPATH_RESOURCE_LOCATIONS + "static/works/")
                .setCachePeriod(20);
        registry.addResourceHandler("/bower_components/**")
                .addResourceLocations(CLASSPATH_RESOURCE_LOCATIONS + "bower_components/").setCachePeriod(20);
        registry.addResourceHandler("/data/**").addResourceLocations(CLASSPATH_RESOURCE_LOCATIONS + "static/data/")
                .setCachePeriod(20);
